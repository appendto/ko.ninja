define([
	...
	return {
		 ...
		 */
		'supported_rules': ['required', 'minLength', 'maxLength', 'numeric', 'email'],
		/**
		...
		*/
		'rules': {
			...
			'url': function(rule_value, value) {
				return true;
			},

			'urlish': function(rule_value, value) {
				return true;
			},

			'ip': function(rule_value, value) {
				return true;
			},

			'ipv4': function(rule_value, value) {
				return true;
			},

			'ipv6': function(rule_value, value) {
				return true;
			},

			'creditcard': function(rule_value, value) {
				return true;
			},
			...
			'decimal': function(rule_value, value) {
				return true;
			},

			'float': function(rule_value, value) {
				return true;
			},
			...
			'date': function(rule_value, value) {
				return true;
			},

			'hexColor': function(rule_value, value) {
				return true;
			},
			...
			'regex': function(rule_value, value) {
				return true;
			},

			'notRegex': function(rule_value, value) {
				return true;
			},
