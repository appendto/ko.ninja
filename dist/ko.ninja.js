	...
	_.extend(NinjaModel.prototype, /** @lends NinjaModel.prototype */ {
		...
		*/
		'_initialize': function(attributes) {
			...
			if (attributes._caller) {
				this._caller = attributes._caller;
				delete attributes._caller;
			}
			...
			if (this.collections) {
				_.each(this.collections, function (Collection, name) {
					...
					data[this.idAttribute] = this[this.idAttribute]();
					this[name] = ko.observable(new Collection(data));
				}, this);
			}
